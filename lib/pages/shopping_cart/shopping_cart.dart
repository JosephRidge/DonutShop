...
import 'package:donutshop/widgets/donut_shopping_list.dart';
          ...
          children: [
            ...
            FadeTransition(
              opacity: Tween(begin: 0.0, end: 1.0)
                ...
                child: Image.network(constants.Utils.donutTitleMyDonuts, width: 170)
            ),
            Expanded(
                ...
                return Row(
                  ...
                  children: [
                    cartService.cartDonuts.isEmpty ? SizedBox() : Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Total', style: TextStyle(color: constants.Utils.mainDark)),
                    ...
                    ClipRRect(
                      ...
                      child: Material(
                        color: cartService.cartDonuts.isEmpty ? 
                          Colors.grey[200] : constants.Utils.mainColor.withOpacity(0.2),
                        child: InkWell(
                          splashColor: constants.Utils.mainDark.withOpacity(0.2),
                          highlightColor: constants.Utils.mainDark.withOpacity(0.5),
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.delete_forever, 
                                  color: cartService.cartDonuts.isEmpty ? 
                                  Colors.grey : constants.Utils.mainDark
                                ),
