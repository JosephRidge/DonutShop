      ...
      child: Row(
        children: [
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(width: 2, color: constants.Utils.mainDark.withOpacity(0.2))
                  ),
                  child: Text('\$${donut!.price!.toStringAsFixed(2)}', 
                    style: TextStyle(color: constants.Utils.mainDark.withOpacity(0.4), 
          ...
          IconButton(
            ...
            icon: Icon(Icons.delete_forever, color: constants.Utils.mainColor)
          )
        ]
      )
    );
